...
2. The card displays **outstanding items** (original items minus already-returned quantities/UPIs) and the **return history** (past check-in events with date, approver, items, and a PDF print link).
